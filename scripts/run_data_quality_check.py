...
try:
    import great_expectations as gx  # pyright: ignore[reportMissingImports]
    import pandas as pd
    import logging
    from datetime import datetime
    from src.config import OUTPUT_FILES, setup_logging
...
def main():
    ...
    parser.add_argument("--verbose", action="store_true", help="Show detailed failure information")
    parser.add_argument(
        "--no-fail", action="store_true", help="Don't exit with error code on validation failure"
    )
